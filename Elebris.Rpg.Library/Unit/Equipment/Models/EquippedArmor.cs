...
namespace Elebris.Core.Library.Items
{
    public class EquippedArmor : EquippedGear
    {
        ...
        public DamageTypeContainer SpellValue = new DamageTypeContainer(DamageType.Spell);
        public DamageTypeContainer PhysicalValue = new DamageTypeContainer(DamageType.Physical);
        public DamageTypeContainer RangedValue = new DamageTypeContainer(DamageType.Ranged);
