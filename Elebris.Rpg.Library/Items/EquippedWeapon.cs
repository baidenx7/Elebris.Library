...
namespace Elebris.Core.Library.Items
{
    ...
    {
        public EquippedWeapon(ActionDamageType type, ActionSubtype subtype, Elements element, float actionCritChance, 
        ...
        public override void OnEquip(CharacterValueContainer character)
        {

        }

        public override void OnUnEquip(CharacterValueContainer character)
        {
