...
{
    public struct CharacterTraitValue
    {
        ...
        public CharacterTraitValue(float initialValue, float successPriorityValue, float failurePriorityValue, float weightRecovery, int stressValue)
        {
            weight = initialValue;
