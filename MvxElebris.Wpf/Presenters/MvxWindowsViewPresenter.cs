...
namespace MvxElebris.Wpf.Presenters
{
      ...
      : MvxAttributeViewPresenter, IMvxWindowsViewPresenter
    {
        ...
        public MvxWindowsViewPresenter(IMvxWindowsFrame rootFrame)
        {
            ...
            //SystemNavigationManager.GetForCurrentView().BackRequested += BackButtonOnBackRequested;*** UAP specific?***
        }
        ...
        {
            //are these supposed to be... method bindings? SHowpage etc dont have params
